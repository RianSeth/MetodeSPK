...
@section('content')
    <div x-data="{ showAdd: false }"
        ...
        @include('data.wp.kriteria.crud.add')
                            ...
                            <table class="min-w-full text-left text-sm font-light">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-4">Kriteria</th>
                                        <th scope="col" class="px-6 py-4">Bobot</th>
                                        <th scope="col" class="px-6 py-4">Atribut</th>
                                        <th scope="col" class="px-6 py-4"> - </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($kriterias as $kriteria)
                                        <tr class="border-b text-center dark:border-neutral-500 hover:bg-neutral-100">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">{{ $kriteria->kode }}</td>
                                            <td class="whitespace-nowrap px-6 py-4">{{ $kriteria->kriteria }}</td>
                                            <td class="whitespace-nowrap px-6 py-4">{{ $kriteria->bobot }}</td>
                                            <td class="whitespace-nowrap px-6 py-4">{{ $kriteria->atribut }}</td>
