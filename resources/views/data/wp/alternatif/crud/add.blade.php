<div x-show="showAddAl" class="absolute left-0 top-0 w-full h-screen mt-2 flex justify-center items-center z-50"">
    <div x-on:click="showAddAl = !showAddAl" class="fixed left-0 top-0 w-full h-screen bg-black/50"></div>
    ...
    <div x-transition
        ...
        <form action="{{ route('alternatifwpcreate') }}" method="post">
            @csrf

            <div class="mb-4 text-base text-neutral-600 dark:text-neutral-200">
                <div class="relative mb-3" data-te-input-wrapper-init>
                    <input type="text" name="kode" value="{{ $newCodeAlternatif }}"
